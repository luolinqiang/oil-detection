...
public enum ReturnCode {
    ...
    ERROR_SHOP_NOT_PUBLISHED(1301, "该店铺尚未发布"),    
    ERROR_SHOP_ADD_UNIQUE(1302, "该用户已经关联店铺"),
    ERROR_CART_MIN_MAX_ERROR(1201, "购物车数量必须在0-1000之间"),
    ERROR_ORDER_NOT_OPEN(1202, "预约时间超出范围，请重新填写"),
    ERROR_ORDER_NOT_EDIT(1203, "订单不可修改"),
