package com.oil.detection.http;
...
//            method.getParams().setParameter(HttpMethodParams.RETRY_HANDLER, new DefaultHttpMethodRetryHandler());
            ...
            logger.debug("http {} request:{}", HttpRequest.METHOD_GET, method.getURI().toString());
        ...
        try {
            ...
            logger.debug("http response:{}", response.getStringResult());
        } catch (UnknownHostException ex) {
            logger.error("http error:{} , {}", ex.getMessage(), ex.getCause());
            throw new RuntimeException("远程调用异常", ex.getCause());
